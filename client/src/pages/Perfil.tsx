      ...
      {open && (
        ...
        >
          ...
          <div className="flex items-center gap-3 px-5 pt-5 pb-4" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <h1 className="text-white text-lg font-bold flex-1" style={{ fontFamily: "Nunito, sans-serif" }}>
              Meus Dados
            </h1>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-5 pt-5 pb-6" style={{ scrollbarWidth: "none" }}>
            ...
            <div className="space-y-4 mb-6">
              <div>
                <label className="text-white/60 text-xs font-semibold uppercase tracking-wider mb-1.5 block" style={{ fontFamily: "Inter, sans-serif" }}>
                  Nome completo
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/6 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white text-sm focus:border-[#F97316]/50 focus:outline-none focus:ring-1 focus:ring-[#F97316]/30 transition-all"
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    style={{
                      ...
                      background: faixaEtaria === "6-10" ? "linear-gradient(135deg, #F97316, #F59E0B)" : "rgba(255,255,255,0.06)",
                      color: faixaEtaria === "6-10" ? "white" : "rgba(255,255,255,0.4)",
                      border: faixaEtaria === "6-10" ? "none" : "1px solid rgba(255,255,255,0.1)",
                    }}
                  >
                    6 a 10 anos
                  </button>
                  <button
                    ...
                    style={{
                      fontFamily: "Inter, sans-serif",
                      background: faixaEtaria === "11-14" ? "linear-gradient(135deg, #F97316, #F59E0B)" : "rgba(255,255,255,0.06)",
                      color: faixaEtaria === "11-14" ? "white" : "rgba(255,255,255,0.4)",
                      border: faixaEtaria === "11-14" ? "none" : "1px solid rgba(255,255,255,0.1)",
                    }}
                  >
                    11 a 14 anos
                  </button>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-white font-bold text-base" style={{ fontFamily: "Nunito, sans-serif" }}>
                  Alterar senha
                </span>
              </div>
              <motion.div
              ...
              {showPasswordSection && (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-white/6 border border-white/10 rounded-xl py-3 pl-10 pr-11 text-white text-sm placeholder:text-white/25 focus:border-[#7C3AED]/50 focus:outline-none focus:ring-1 focus:ring-[#7C3AED]/30 transition-all"
                        style={{ fontFamily: "Inter, sans-serif" }}
                      />
                      <button
                  ...
                  <div>
                    ...
                    <p className="text-[#F59E0B] text-xs mt-1" style={{ fontFamily: "Inter, sans-serif" }}>
                      Força: Média
                    </p>
                  </div>
      ...
      <div className="relative flex-1 overflow-hidden">
        <div className="flex-1 h-full overflow-y-auto" style={{ scrollbarWidth: "none" }}>
            ...
            <div className="flex flex-col items-center">
              <button onClick={() => setShowDados(true)} className="relative mb-3 group">
                <img
                  src={IMAGES.avatarBoy}
                  alt="Avatar"
                  className="w-20 h-20 rounded-full object-cover border-3 border-white/30 group-hover:border-white/60 transition-all"
                />
          ...
          >
            <button
              onClick={() => setShowDados(true)}
              className="w-full labia-card p-4 flex items-center justify-between hover:border-[#F97316]/30 transition-all"
            >
        ...
        {/* Drawer de Dados Pessoais + Alterar Senha */}
