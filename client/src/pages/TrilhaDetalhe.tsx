  ...
  return (
    <PhoneFrame>
      <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        ...
        {/* Badge earned card */}
        <motion.div className="mx-6 mt-5 p-4 rounded-2xl border border-[#10B981]/20 bg-[#10B981]/8"
        ...
        <div className="px-6 mt-6 mb-3">
          <h2 className="text-base font-bold" style={{ fontFamily: "Nunito, sans-serif", color: t.textPrimary }}>
            Missões da Trilha
          </h2>
        ...
        <div className="px-6 pb-6">
          {missions.map((mission, i) => (
            <motion.div key={mission.id} className="flex gap-4 relative"
              ...
              <button className="flex-1 pb-8 text-left group"
                onClick={() => setLocation(`/missao/prompts/${mission.id}`)}>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="text-xs font-semibold" style={{ fontFamily: "Inter, sans-serif", color: t.textMuted }}>
                        Missão {mission.id}
                      </span>
                    </div>
                  ...
                  <ChevronRight size={16} className="group-hover:text-[#10B981] transition-colors flex-shrink-0 mt-2" style={{ color: t.textMuted }} />
                </div>
                <p className="text-sm mt-1 leading-relaxed" style={{ fontFamily: "Inter, sans-serif", color: t.textSecondary }}>
                  {mission.description}
                </p>
        ...
        <motion.div className="px-6 pb-8" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}>
          <button onClick={() => setLocation("/trilha-solucoes")}
            ...
            style={{ fontFamily: "Nunito, sans-serif", boxShadow: "0 4px 20px rgba(249,115,22,0.35)" }}>
            <Sparkles size={16} />
