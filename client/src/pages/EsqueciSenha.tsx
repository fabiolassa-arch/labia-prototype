 ...
 * Etapas: 1) Inserir e-mail, 2) Código de verificação, 3) Nova senha, 4) Confirmação
 * Design: Fundo escuro, cards com ícones animados, stepper de progresso
        ...
        <div key={i} className="flex items-center gap-2">
          <motion.div
            ...
            style={{
              ...
              color: i + 1 <= current ? "white" : "rgba(255,255,255,0.3)",
              border: i + 1 === current ? "2px solid rgba(255,255,255,0.2)" : "none",
            }}
            animate={{
              scale: i + 1 === current ? [1, 1.08, 1] : 1,
            }}
            transition={{
              duration: 1.5,
              repeat: i + 1 === current ? Infinity : 0,
              ease: "easeInOut",
            }}
          >
          ...
          {i < total - 1 && (
            <div
              ...
              style={{
                width: 24,
                background: i + 1 < current ? "#10B981" : "rgba(255,255,255,0.08)",
              }}
            />
          )}
        </div>
  ...
  return (
    ...
    >
      ...
      <p
        ...
        style={{ color: colors[strength], fontFamily: "Inter, sans-serif" }}
      >
        {labels[strength]}
      </p>
    </motion.div>
...
function StepEmail({
  ...
  return (
    ...
    >
      ...
      <p
        className="text-white/45 text-sm text-center mb-6 leading-relaxed"
      ...
      <div className="relative mb-2">
        ...
        <input
          ...
          className="labia-input pl-11 w-full"
          autoFocus
        />
        {isValid && (
          <motion.div
      ...
      {/* Info card */}
      <div
        className="flex items-start gap-3 p-3 rounded-xl mt-4 mb-6"
        style={{
      ...
      <button
        onClick={onNext}
        disabled={!isValid}
        className="labia-btn-primary w-full py-3.5 text-sm flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
      >
        Enviar código
        <ArrowRight size={16} />
      </button>
...
function StepCode({
  ...
  return (
    ...
    >
      ...
      <p
        className="text-white/45 text-sm text-center mb-1 leading-relaxed"
        style={{ fontFamily: "Inter, sans-serif" }}
      >
        Enviamos um código de 6 dígitos para:
      </p>
      <p
        className="text-[#F97316] text-sm text-center font-semibold mb-6"
        style={{ fontFamily: "Inter, sans-serif" }}
      >
        {email}
      </p>
      ...
      <div className="flex justify-center gap-2 mb-4" onPaste={handlePaste}>
        {code.map((digit, i) => (
          <motion.input
            ...
            className="w-11 h-13 text-center text-white text-xl font-bold rounded-xl outline-none transition-all"
            style={{
              fontFamily: "Inter, sans-serif",
              background: digit ? "rgba(124,58,237,0.12)" : "rgba(255,255,255,0.04)",
              border: digit
      ...
      <div className="flex items-center justify-center gap-2 mb-6">
        {canResend ? (
          <button
            ...
            className="flex items-center gap-1.5 text-[#F97316] text-sm font-semibold"
            style={{ fontFamily: "Inter, sans-serif" }}
          >
            <RefreshCw size={14} />
            Reenviar código
          ...
          <div className="flex items-center gap-1.5 text-white/30 text-sm" style={{ fontFamily: "Inter, sans-serif" }}>
            <Timer size={14} />
      ...
      <button
        onClick={onNext}
        disabled={!isComplete}
        className="labia-btn-primary w-full py-3.5 text-sm flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed mb-3"
      >
        Verificar código
        <ArrowRight size={16} />
      </button>
...
function StepNewPassword({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 mb-2">
        <div className="relative">
          ...
          <input
            ...
            className="labia-input pl-11 pr-12 w-full"
            autoFocus
          />
          <button
        ...
        {mismatch && (
          <motion.p
            className="text-[#EF4444] text-[11px] px-1"
            style={{ fontFamily: "Inter, sans-serif" }}
      ...
      {/* Tips */}
      <div
        className="flex flex-col gap-1.5 p-3 rounded-xl mt-4 mb-6"
        style={{
          background: "rgba(16,185,129,0.06)",
          border: "1px solid rgba(16,185,129,0.1)",
        }}
      >
        <p className="text-white/50 text-[11px] font-semibold mb-1" style={{ fontFamily: "Inter, sans-serif" }}>
        ...
        {[
          ...
          <div key={i} className="flex items-center gap-2">
            <div
              ...
              style={{
                background: tip.ok ? "#10B981" : "rgba(255,255,255,0.08)",
              }}
            >
            ...
            <p
              ...
              style={{
                color: tip.ok ? "rgba(16,185,129,0.8)" : "rgba(255,255,255,0.35)",
                fontFamily: "Inter, sans-serif",
              }}
            >
              {tip.text}
...
function StepSuccess({ onLogin }: { onLogin: () => void }) {
  return (
    ...
    >
      ...
      <p
        className="text-white/45 text-sm mb-2 leading-relaxed"
        style={{ fontFamily: "Inter, sans-serif" }}
      >
      ...
      {/* Success card */}
      <motion.div
        className="w-full p-4 rounded-2xl my-5"
        style={{
      ...
      >
        ...
        <div className="flex flex-col gap-1.5">
          {[
            ...
            "Notificação enviada ao seu e-mail",
          ].map((item, i) => (
            <div key={i} className="flex items-center gap-2">
              <CheckCircle2 size={12} className="text-[#10B981] flex-shrink-0" />
              <p className="text-white/45 text-[11px]" style={{ fontFamily: "Inter, sans-serif" }}>
                {item}
              </p>
            </div>
          ))}
      ...
      <button
        onClick={onLogin}
        className="labia-btn-primary w-full py-3.5 text-sm flex items-center justify-center gap-2"
      >
      ...
      {/* Tutor message */}
      <motion.div
        className="flex items-center gap-3 mt-5 p-3 rounded-xl w-full"
        style={{
          background: "rgba(124,58,237,0.06)",
          border: "1px solid rgba(124,58,237,0.1)",
        }}
      ...
      >
        ...
        />
        <p className="text-white/40 text-[11px] leading-relaxed text-left" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        ...
        >
          <div className="flex items-center gap-3 px-5 pt-14 pb-3">
            <button
              onClick={() => {
                if (step === 1) setLocation("/cadastro");
                else if (step === 4) setLocation("/home");
                else setStep(step - 1);
              }}
        ...
        <div className="px-5 pb-8">
          <AnimatePresence mode="wait">
            ...
            {step === 3 && (
              <StepNewPassword onNext={() => setStep(4)} />
            )}
            {step === 4 && (
              <StepSuccess onLogin={() => setLocation("/home")} />
            )}
          </AnimatePresence>
        </div>
      </div>
