 ...
 * Design: Banner gradiente roxo-azul, 100% concluída, 5 missões clicáveis
    ...
    <PhoneFrame>
      <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        ...
        >
          ...
          {/* 100% badge */}
          <motion.div
            className="absolute top-14 right-5 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1"
            style={{
        ...
        >
          ...
          >
            ...
            <div>
              <p className="text-[#A78BFA] text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: "Inter, sans-serif" }}>
              ...
              <p className="text-white/50 text-xs mt-0.5" style={{ fontFamily: "Inter, sans-serif" }}>
                Você criou seu primeiro app do zero!
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="labia-card p-4">
            <div className="space-y-3">
              {[
                ...
                "Definir público-alvo com personas",
                "Priorizar funcionalidades com MVP",
                "Estruturar telas e hierarquia visual",
        ...
        >
          ...
          >
            ...
            <div>
              <p className="text-[#10B981] text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: "Inter, sans-serif" }}>
                Resultado entregue
              </p>
              <p className="text-white font-bold text-sm mt-0.5" style={{ fontFamily: "Nunito, sans-serif" }}>
                BiblioTrack — Seu primeiro app!
              </p>
              <p className="text-white/50 text-xs mt-0.5" style={{ fontFamily: "Inter, sans-serif" }}>
                Ideia, personas, funcionalidades, telas e fluxo
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="px-6 pt-5 pb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#10B981] text-xs font-bold" style={{ fontFamily: "Inter, sans-serif" }}>
              5/5
            </span>
          </div>
              ...
              >
                ...
                <div className="flex-1 pb-7">
                  <div className="flex items-start justify-between">
                    <h3
                      className="text-white font-bold text-base leading-tight group-hover:text-[#A78BFA] transition-colors"
                    ...
                    <div className="flex items-center gap-1 ml-2 flex-shrink-0">
                      ...
                      <span className="text-[#F59E0B] text-xs font-bold" style={{ fontFamily: "Inter, sans-serif" }}>
                        {scores[i]}/10
                      </span>
                    </div>
                  </div>
                  <p
                    className="text-white/50 text-sm mt-1 leading-relaxed line-clamp-2"
        ...
        >
          ...
          >
            ...
            <p className="text-white font-bold text-base" style={{ fontFamily: "Nunito, sans-serif" }}>
              Parabéns, Jovem Desenvolvedor!
            </p>
