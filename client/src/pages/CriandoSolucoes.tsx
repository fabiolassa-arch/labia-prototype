 ...
 * Design: Banner gradiente verde-teal, timeline de missões concluídas,
  ...
  return (
    <PhoneFrame>
      <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        ...
        >
          <div
            className="labia-card p-4 flex items-center gap-4"
          ...
          >
            ...
            <div className="flex-1">
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-[#F59E0B] text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: "Inter, sans-serif" }}>
                ...
                <div className="flex-1 pb-7">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p
                        className="text-white/40 text-sm mt-1 leading-relaxed line-clamp-2"
                        style={{ fontFamily: "Inter, sans-serif" }}
                      >
                        {mission.description}
                      </p>
                    </div>
                    <ChevronRight size={16} className="text-white/20 group-hover:text-[#10B981] transition-colors flex-shrink-0 mt-1" />
                  </div>
                  ...
                  {/* Revisar button */}
                  <motion.button
                    className="mt-2 px-4 py-1.5 rounded-xl text-xs font-bold transition-all hover:brightness-110"
                    style={{
                      background: "rgba(16,185,129,0.12)",
                      color: "#10B981",
                      fontFamily: "Nunito, sans-serif",
        ...
        >
          <button
            onClick={() => setLocation("/trilha-meu-app")}
