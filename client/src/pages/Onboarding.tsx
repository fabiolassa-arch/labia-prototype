 ...
 * Design: Robô tutor com mensagem de boas-vindas, carrossel de trilhas,
  ...
  return (
    <PhoneFrame>
      <div className="flex-1 overflow-y-auto flex flex-col" style={{ scrollbarWidth: "none" }}>
        {/* Tutor Robot Section */}
        <motion.div
          className="flex flex-col items-center pt-6 pb-4 px-6"
          ...
          <div className="flex gap-3 overflow-x-auto pb-2" style={{ scrollbarWidth: "none" }}>
            {PREVIEW_TRACKS.map((track, i) => {
              ...
              return (
                <motion.div
                  key={i}
                  className="flex-shrink-0 w-28 rounded-2xl p-4 flex flex-col items-center gap-2 text-center"
                  style={{
                ...
                >
                  ...
                  <span
                    className="text-white text-xs font-bold leading-tight whitespace-pre-line"
        ...
        >
          <button
            ...
            className="labia-btn-primary w-full text-base py-4"
          >
