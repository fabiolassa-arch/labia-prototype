...
export const MISSION_DETAILS: MissionDetail[] = [
  ...
  // --- Trilha: Meu Primeiro App ---
  {
    id: "meu-primeiro-app-1",
    trackSlug: "meu-primeiro-app",
    trackTitle: "Meu Primeiro App",
    trackColor: "#7C3AED",
    missionNumber: 1,
    title: "Defina a ideia do seu app",
    objective: "Escolher um problema real para resolver e dar um nome criativo ao aplicativo, definindo sua proposta de valor.",
    challenge: "Pense em um problema que você ou pessoas ao seu redor enfrentam no dia a dia. Defina: 1) Qual é o problema? 2) Qual é a sua ideia de app para resolvê-lo? 3) Dê um nome criativo ao app. 4) Escreva o slogan em uma frase.",
    studentAnswer: "1) Problema: Na minha escola, os alunos esquecem de devolver livros da biblioteca, e a bibliotecária perde muito tempo cobrando. 2) Ideia: Um app que registra empréstimos com QR code, envia lembretes automáticos e gamifica a devolução com pontos e recompensas. 3) Nome: BiblioTrack. 4) Slogan: 'Leia, devolva, pontue!' — porque combina as 3 ações principais do app de forma divertida.",
    tutorFeedback: "Excelente começo, Lucas! O BiblioTrack é uma ideia sólida porque resolve um problema real que você vivencia. O nome é memorável e fácil de pronunciar, e o slogan resume perfeitamente a proposta. Você já demonstrou visão de produto ao incluir gamificação como diferencial. Essa base vai guiar todo o desenvolvimento do seu app!",
    score: 10,
    maxScore: 10,
    completedAt: "07 Mar 2026",
    tips: ["Boas ideias de app resolvem problemas reais que você conhece bem", "O nome do app deve ser fácil de lembrar e pronunciar", "Um bom slogan resume a proposta de valor em poucas palavras"],
    tags: ["Ideação", "Naming", "Proposta de valor"],
  },
  {
    id: "meu-primeiro-app-2",
    trackSlug: "meu-primeiro-app",
    trackTitle: "Meu Primeiro App",
    trackColor: "#7C3AED",
    missionNumber: 2,
    title: "Quem vai usar seu app?",
    objective: "Definir o público-alvo do aplicativo, criando personas e entendendo suas necessidades e comportamentos.",
    challenge: "Crie 2 personas para o seu app: para cada uma, defina nome, idade, o que faz, qual problema enfrenta, e como seu app ajudaria. Depois, responda: qual é o público principal e qual é o secundário?",
    studentAnswer: "Persona 1 — Maria, 12 anos, aluna do 7º ano: Adora ler mas sempre esquece de devolver os livros no prazo. Já perdeu o direito de pegar livros novos 2 vezes. O BiblioTrack ajudaria com lembretes divertidos e pontos que ela pode trocar por mais tempo de empréstimo. Persona 2 — Dona Cláudia, 45 anos, bibliotecária: Gasta 2 horas por semana cobrando devoluções atrasadas. O BiblioTrack mostraria um painel com todos os empréstimos e enviaria cobranças automáticas. Público principal: alunos de 8 a 14 anos. Público secundário: bibliotecários e professores.",
    tutorFeedback: "Personas muito bem construídas, Lucas! Você criou perfis realistas com problemas específicos e mostrou como o app resolve cada um. A distinção entre público principal (alunos) e secundário (bibliotecários) mostra maturidade no pensamento de produto. Detalhe brilhante: você pensou em funcionalidades diferentes para cada persona — isso é design centrado no usuário!",
    score: 10,
    maxScore: 10,
    completedAt: "07 Mar 2026",
    tips: ["Personas ajudam a tomar decisões de design — sempre pergunte: 'O que a Maria faria?'", "Público principal usa o app diretamente, público secundário se beneficia indiretamente", "Cada persona deve ter um problema específico que seu app resolve"],
    tags: ["Personas", "Público-alvo", "Design centrado no usuário"],
  },
  {
    id: "meu-primeiro-app-3",
    trackSlug: "meu-primeiro-app",
    trackTitle: "Meu Primeiro App",
    trackColor: "#7C3AED",
    missionNumber: 3,
    title: "Liste as funcionalidades",
    objective: "Definir as funcionalidades essenciais do app, priorizando o que é mais importante para o MVP (Produto Mínimo Viável).",
    challenge: "Liste todas as funcionalidades que seu app poderia ter. Depois, classifique cada uma como: Essencial (precisa ter no lançamento), Importante (pode vir depois) ou Legal (seria bom ter no futuro). Escolha as 5 funcionalidades essenciais.",
    studentAnswer: "Funcionalidades do BiblioTrack: ESSENCIAIS: 1) Cadastro de aluno com foto e turma, 2) Scanner QR para registrar empréstimo/devolução, 3) Lembretes automáticos (3 dias antes, 1 dia antes, no dia), 4) Sistema de pontos por devolução no prazo, 5) Painel da bibliotecária com lista de empréstimos. IMPORTANTES: 6) Ranking dos alunos com mais pontos, 7) Histórico de livros lidos, 8) Resenhas e avaliações de livros. LEGAIS: 9) Recomendação de livros por IA, 10) Clube do livro virtual, 11) Integração com catálogo online da biblioteca.",
    tutorFeedback: "Priorização exemplar, Lucas! Você listou 11 funcionalidades e classificou cada uma com critério. As 5 essenciais formam um MVP completo: cadastro, scanner, lembretes, pontos e painel. Isso é exatamente o que uma startup faria — lançar com o mínimo necessário e ir melhorando. As funcionalidades 'Importantes' e 'Legais' mostram visão de longo prazo. Você está pensando como um Product Manager!",
    score: 9,
    maxScore: 10,
    completedAt: "08 Mar 2026",
    tips: ["MVP = Produto Mínimo Viável — lance com o essencial e melhore depois", "Priorize funcionalidades que resolvem o problema principal", "Funcionalidades 'legais' podem virar diferenciais no futuro"],
    tags: ["Funcionalidades", "MVP", "Priorização"],
  },
  {
    id: "meu-primeiro-app-4",
    trackSlug: "meu-primeiro-app",
    trackTitle: "Meu Primeiro App",
    trackColor: "#7C3AED",
    missionNumber: 4,
    title: "Desenhe as telas do app",
    objective: "Estruturar as telas principais do aplicativo, definindo o layout, os elementos visuais e a hierarquia de informação.",
    challenge: "Descreva em detalhes 4 telas do seu app: 1) Tela de Login/Boas-vindas, 2) Tela Principal (Home), 3) Tela de uma funcionalidade essencial, 4) Tela de Perfil. Para cada uma, liste os elementos que aparecem e onde ficam posicionados.",
    studentAnswer: "Tela 1 — Login: Logo do BiblioTrack no topo (livro + foguete), campo de e-mail e senha no centro, botão 'Entrar' laranja grande, link 'Criar conta' embaixo, fundo azul com ilustração de livros. Tela 2 — Home: Header com foto do aluno e pontos, card 'Livros emprestados' com contagem regressiva, seção 'Ranking da semana' com top 3, botão flutuante de scanner QR no canto inferior. Tela 3 — Scanner QR: Câmera aberta com moldura de QR centralizada, instrução 'Aponte para o QR do livro', após escanear mostra dados do livro e botão 'Confirmar empréstimo/devolução'. Tela 4 — Perfil: Foto e nome do aluno, nível e barra de XP, histórico de livros lidos com capas, insígnias conquistadas, botão de configurações.",
    tutorFeedback: "Descrição detalhada e profissional, Lucas! Cada tela tem elementos claros, bem posicionados e com propósito. Adorei o botão flutuante de scanner QR na Home — mostra que você pensou na usabilidade. A tela de Scanner é simples e direta, exatamente como deve ser. O Perfil com nível, XP e insígnias reforça a gamificação. Você está desenhando como um UX Designer!",
    score: 10,
    maxScore: 10,
    completedAt: "08 Mar 2026",
    tips: ["Cada tela deve ter um objetivo claro — o que o usuário faz aqui?", "Elementos mais importantes ficam no topo ou no centro da tela", "Botões de ação principal devem ser grandes e coloridos"],
    tags: ["Wireframe", "UI Design", "Hierarquia visual"],
  },
  {
    id: "meu-primeiro-app-5",
    trackSlug: "meu-primeiro-app",
    trackTitle: "Meu Primeiro App",
    trackColor: "#7C3AED",
    missionNumber: 5,
    title: "Monte o fluxo principal",
    objective: "Conectar as telas e definir o caminho que o usuário percorre do início ao fim, criando o fluxo de navegação completo.",
    challenge: "Desenhe o fluxo completo do seu app: 1) Por onde o usuário começa? 2) Quais são os 3 caminhos principais que ele pode seguir? 3) Como ele volta para a tela inicial? 4) O que acontece em caso de erro? Descreva cada passo.",
    studentAnswer: "Fluxo do BiblioTrack: INÍCIO: Splash → Login → Home. CAMINHO 1 (Pegar livro): Home → Botão Scanner → Escanear QR → Confirmar empréstimo → Animação de pontos → Home (livro aparece na lista). CAMINHO 2 (Devolver livro): Home → Botão Scanner → Escanear QR → Confirmar devolução → Animação de +50 pontos → Tela de parabéns se subiu de nível → Home. CAMINHO 3 (Ver ranking): Home → Aba Ranking → Lista de alunos → Tocar em aluno → Ver perfil público. NAVEGAÇÃO: Barra inferior com 4 abas (Home, Scanner, Ranking, Perfil). ERROS: QR inválido → Mensagem 'Livro não encontrado, tente novamente' com botão de tentar. Sem internet → Mensagem 'Sem conexão' com opção de modo offline.",
    tutorFeedback: "Fluxo completo e profissional, Lucas! Você cobriu todos os aspectos: início, caminhos principais, navegação global e tratamento de erros. A barra inferior com 4 abas é uma escolha inteligente para navegação mobile. Os detalhes de animação de pontos e tela de parabéns mostram que você pensou na experiência emocional do usuário. O tratamento de erros com QR inválido e modo offline demonstra maturidade técnica. Parabéns — você completou a trilha Meu Primeiro App! Você agora é um Jovem Desenvolvedor!",
    score: 10,
    maxScore: 10,
    completedAt: "09 Mar 2026",
    tips: ["Todo app precisa de um fluxo claro: início → ação → resultado", "Sempre pense no que acontece quando algo dá errado", "A navegação global (barra inferior) deve estar acessível em todas as telas"],
    tags: ["Fluxo de navegação", "UX Flow", "Tratamento de erros"],
  },
];
